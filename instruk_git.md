...
добавили ссылку и разную информацию
чтобы создать конфликт
Ссылки на документы в общих папках с использованием file:// не поддерживаются в 2017.1 и более поздних версиях. Это ограничение было реализовано в целях безопасности.

Сведения о том, как указать относительные ссылки со страницы приветствия или мини-приложения Markdown, см. в разделе Относительные ссылки системы управления версиями.
